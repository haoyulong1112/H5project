    ...
    <div class="login">
        <div class="user-form">
            ...
            <div class="form-code">
                ...
                <span :class="getCodeBtnClass" @click.stop="getCode">{{getCodeBtnText}}</span>
            </div>
        </div>
...
import { getLoginImageCode } from '@/api'
...
export default {
    ...
    methods: {
        ...
        updateCode () {
            ...
            this.imgcodeUrl = getLoginImageCode(this.mobileKey)
        },
        // 倒计时
        countdown (cb) {
            // 倒计时
...
.form-code > span
    ...
    line-height: 0.8rem;
    text-align: center;
    background-image: linear-gradient(0deg, #FF521D 0%, #FF7B2A 100%);
