<template>
    <div class="container">
        <img class="bgc" src="~@static/images/202212/bgc.png" alt="">
        <div class="content">
            <div class="title">
            ...
            <div class="formbox">
                <img class="formboxbgc" src="~@static/images/202212/red.png" alt="">
                <img class="formboxboy" src="~@static/images/202212/boy.png" alt="">
                <div class="form">
                    <div class="formitem">
                        <input type="number" placeholder="请输入手机号" autocomplete="new-password" class="phone" maxlength="11" @input="phoneChcnge" v-model="form.cellPhone">
                    </div>
                    <div class="formitem">
                        <input type="number" placeholder="请输入验证码" autocomplete="new-password" class="password" @input="codeChcnge" v-model="form.code">
                        <span @click="getCode" :class="codeType == 1 ? 'codeclass' : 'codeclass code'" class="codeclass">{{codeText}}</span>
                    </div>
                </div>
